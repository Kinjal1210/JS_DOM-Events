...
node2.textContent = "I used the getElementsByClassName('node') method to access this";
...
newParagraph.textContent = "This node was crated using the creatElement() method";
...
addlink.textContent = "I am an <a> tag";

// BONUS: Add a link href to the <a>
addlink.href = "https://truecoders.io/";


// TODO: Insert the created <a> in the parent but before the <p> you just created using the element.insertBefore() method

parent.insertBefore(addlink, newParagraph);
...
newChildNode.textContent = "Child Node replace old Child";
